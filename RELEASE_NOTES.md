...
- Header, tab bar and section menu - a menu element can now be any widget, either a reference to one that already sits on a dashboard or an instance of its own; its conditions, badges and click actions work there just as they do on the dashboard (#634)
