...
| Frontend im selben Browser | Das Frontend zeigt immer den gespeicherten Stand. Läuft es im selben Browser wie ein Admin mit ungespeicherten Änderungen, lässt es dessen Kopie und Markierung unangetastet (bis 0.60.8 wurden sie beim Öffnen des Frontends überschrieben) |
