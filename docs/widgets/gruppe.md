...
### Default
Kind-Widgets in einem inneren Raster. Die Gruppe ist mindestens so hoch wie ihre Kinder (Kinderzeilen + Kopfzeile) und wächst automatisch mit; im Editor lässt sie sich höher ziehen, die Kinder füllen den Platz dann gleichmäßig. Eine Rasterzeile ist in der Gruppe genauso viel wert wie auf dem Tab. **Höhe an Inhalt anpassen** im Bearbeiten-Dialog führt zurück auf die Mindesthöhe. Der Griff mit dem Ebenen-Symbol an einem Kind: Klick legt es zurück auf den Tab, Ziehen bringt es in eine andere Gruppe.
