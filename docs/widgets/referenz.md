...
| `entries[].aggregate`       | `last` · `delta` · `consumption` · `sum` · `average` · `max` · `min`  | `last`             | reduziert den Eintrag auf EINEN Wert im Zeitraum (`consumption` = Zuwachs, auch bei Tageszählern) |
