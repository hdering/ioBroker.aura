                                    ...
                                    <div className="flex gap-1 shrink-0">
                                        {['--widget-bg', '--accent', '--accent-green'].map((v) => (
                                            <div
                                                ...
                                                style={{
                                                    background: theme.vars[v as keyof ThemeVars],
                                                    borderColor: theme.vars['--app-border'],
                                                }}
                                            />
                                        ))}
                                    </div>
                    ...
                    {tab === 'custom' && (
                        <div className="aura-scroll p-3 space-y-2 max-h-80 overflow-y-auto">
                            <p className="text-xs mb-3" style={{ color: 'var(--text-secondary)' }}>
                                Basierend auf:{' '}
                                <strong style={{ color: 'var(--text-primary)' }}>{activeTheme.name}</strong>
                            </p>
                                    ...
                                    <div key={key} className="flex items-center gap-2">
                                        ...
                                        <div className="flex-1 flex gap-1">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) =>
                                                    setCustomVar(key, e.target.value || activeTheme.vars[key])
                                                }
