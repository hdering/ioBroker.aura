...
const SIZE_MAP: Record<LayoutDrawerSize, { icon: number; container: number; floatIcon: number; floatContainer: number }> = {
...
export function LayoutDrawer({
  ...
  useEffect(() => {
    if (!autoHide || !floating) { setProximityVisible(true); return; }
