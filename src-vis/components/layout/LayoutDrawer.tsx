...
export function LayoutDrawer({
    ...
    if (variant === 'bar') {
        ...
        const containerStyle: React.CSSProperties = {
            ...
            // Divider faces the dashboard (same rule as the tab bar): below the bar at the
            // top, above the bar as a footer — so a footer bar keeps its subtle separating
            // line instead of losing it to the invisible screen edge.
