  ...
  return (
    ...
    >
      ...
      {openPanel === 'edit' && (
        ...
        >
          {/* ─── 1. Name / Titel ──────────────────────────────────────────── */}
          {!['shutter', 'switch', 'dimmer', 'slider'].includes(config.type) && (<>
          ...
          <div className="space-y-2.5">
            ...
            {config.type !== 'stateimage' && config.type !== 'windowcontact' && !['shutter', 'switch', 'dimmer', 'slider'].includes(config.type) && (() => {
            ...
            {/* Icon-Größe */}
            {!['clock', 'calendar', 'gauge', 'chart', 'echart', 'echartsPreset', 'fill', 'iframe', 'html', 'jsontable', 'image', 'camera', 'list', 'autolist', 'header', 'trash', 'trashSchedule', 'evcc', 'weather', 'group', 'shutter', 'switch', 'dimmer', 'slider'].includes(config.type) && (() => {
              const o = config.options ?? {};
