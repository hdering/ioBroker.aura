export const de = {
    ...
    'settings.header.addItem': '+ Element hinzufügen',
    'settings.header.posLeft': 'Links',
    'settings.header.posRight': 'Rechts',
    'settings.header.legacyHint':
        'Die früheren Einzelfelder für Uhrzeit und Datenpunkt wurden in diese Liste übernommen.',

    'menuItem.widget.source': 'Quelle',
    'menuItem.widget.sourceRef': 'Vorhandenes Widget',
    'menuItem.widget.sourceOwn': 'Eigenes Widget',
    'menuItem.widget.pick': 'Ziel-Widget',
    ...
    'menuItem.widget.previewHintRef':
        'Genau die Box, die das Element im Menü bekommt — an der Ecke pixelgenau größer ziehen. Inhalt und Optionen werden am Original im Dashboard-Editor gepflegt.',
    ...
    'settings.grid.fluid': 'Fensterbreite füllen',
    'settings.grid.fluidHint':
        'Die Widgets strecken sich auf die volle Breite des Fensters. Die Anordnung bleibt, nur die Breite passt sich an; unterhalb der Tablet-/Mobile-Grenze gelten weiter die Spalten-Flüsse. Der Editor zeigt die Entwurfsansicht.',
    'settings.grid.fluidOn': 'Fensterbreite',
    'settings.grid.fluidOff': 'Fest',
    'settings.grid.fluidDesignWidth': 'Entwurfsbreite',
    ...
    'settings.autobackup.change.discard': 'Verwerfen der ungespeicherten Änderungen',
    'settings.autobackup.change.discard.n': 'Verwerfen der ungespeicherten Änderungen ({count} Bereiche)',
    'settings.autobackup.change.restore': 'Wiederherstellung eines gespeicherten Stands',
    'settings.autobackup.change.restore.n': 'Wiederherstellung eines gespeicherten Stands ({count} Bereiche)',
    ...
    'layouts.defaultLayout': 'Standard-Layout',
    'layouts.firstLayoutHint': 'erstes Layout = Startseite',
    'layouts.card.general': 'Allgemein',
    'layouts.card.start': 'Start & Menü',
    'layouts.field.name': 'Name',
    'layouts.field.url': 'URL',
    'layouts.field.icon': 'Icon',
    'layouts.iconNone': 'Kein Icon',
    'layouts.iconRemove': 'Entfernen',
    'layouts.defaultSection': 'Standard-Bereich',
    'layouts.defaultSectionHint': 'Öffnet, wenn die URL keinen Bereich nennt – auch Ziel der Idle-Rückkehr.',
    'layouts.menuDesign': 'Bereichs-Menü & Header',
    ...
    'layouts.deleteConfirm': 'Wirklich löschen?',
    'sections.reorderHint': 'Reihenfolge per Ziehen – sie entspricht dem Bereichs-Menü im Frontend.',
    'sections.openEditor': 'Im Editor öffnen',
    'sections.makeDefaultLong': 'Als Standard-Bereich setzen',
    'sections.deleteLastHint': 'Der einzige Bereich eines Layouts kann nicht gelöscht werden',
    'sections.deleteConfirm': 'Wirklich löschen?',
    'sections.showInMenu': 'Im Menü anzeigen',
    'sections.defaultChip': 'Standard-Bereich',
    'sections.hiddenChip': 'Aus Menü ausgeblendet',
    'sections.field.slug': 'URL-Slug',
    'sections.card.visibility': 'Sichtbarkeit',
    'tabs.title': 'Tabs',
    'tabs.search': 'Tab suchen…',
    'tabs.newTab': 'Neuer Tab',
    'tabs.placeholder': 'Tab-Name, z.B. Wohnzimmer',
    'tabs.reorderHint': 'Reihenfolge per Ziehen – sie entspricht der Tab-Leiste.',
    'tabs.showTitle': 'In der Tab-Leiste anzeigen',
    'tabs.hideTitle': 'Aus der Tab-Leiste ausblenden – bleibt per URL erreichbar',
    'tabs.openEditor': 'Editor',
    'tabs.noMatch': 'Kein Tab passt zur Suche.',
    ...
    'design.subtitle':
        'Global gilt überall · Layouts und Bereiche dürfen abweichen, so weit die Kette in der Zeile reicht.',
    'layouts.subtab.sync': 'Hell/Dunkel-Kopplung',
    'layouts.subtab.mythemes': 'Meine Themes',
    'layouts.subtab.behavior': 'Verhalten',
    'design.band.global': 'Global',
    'design.band.layout': 'Global → Layout',
    'design.band.section': 'Global → Layout → Bereich',
    'design.band.globalHint': 'nicht überschreibbar',
    'design.band.layoutHint': 'Layouts können abweichen',
    'design.band.sectionHint': 'Layouts und Bereiche können abweichen',
    'design.band.editAt': 'unter „{scope}“ bearbeiten',
    'design.tab.ownTitle': '{count} eigene Werte in dieser Gruppe',
    'design.tree.chain': 'Global → Layout → Bereich',
    'design.tree.layout': 'Layout',
    'design.tree.section': 'Bereich von {layout}',
    'design.tree.ownLegend': 'eigene Werte auf dieser Ebene',
    'design.scope.editing': 'Du bearbeitest',
    'design.scope.layoutWord': 'Layout',
    'design.scope.sectionWord': 'Bereich',
    'design.scope.globalText': 'gilt für alle Layouts und Bereiche, die keine eigenen Werte setzen',
    'design.scope.layoutText': 'erbt von Global · seine Bereiche übernehmen es, solange sie nichts Eigenes setzen',
    'design.scope.sectionText': 'erbt von {layout} · gilt nur für diesen Bereich',
    'design.scope.ownOne': 'eigener Wert',
    'design.scope.ownMany': 'eigene Werte',
    'design.scope.ownNone': 'keine eigenen Werte',
    'design.locked.globalTitle': '„{group}“ gilt überall',
    'design.locked.globalText':
        'Diese Einstellungen lassen sich nicht pro Layout oder Bereich überschreiben. {scope} verwendet die globalen Werte.',
    'design.locked.layoutTitle': '„{group}“ wird pro Layout festgelegt',
    'design.locked.layoutText':
        'Ein Bereich hat keinen eigenen Rahmen. {section} übernimmt die Einstellungen von {layout}.',
    'design.locked.jump': 'Unter „{scope}“ bearbeiten',
    'design.override.setHere': 'hier gesetzt',
    'design.override.clear': 'Überschreibung entfernen – erbt wieder',
    'design.override.inheritedFrom': 'geerbt von {scope}',
    'design.override.below': 'abweichend in',
    'design.override.levels': 'Ebenen',
    'design.override.levelsHint':
        'So wirkt die Einstellung auf jeder Ebene. Bearbeitet wird immer der links gewählte Bereich.',
    'design.override.inherits': 'erbt',
    'design.override.remove': 'entfernen',
    'design.override.selected': 'links ausgewählt',
    'design.override.chain3': 'Global → Layout → Bereich: die unterste Ebene mit eigenem Wert gewinnt.',
    'design.override.chain2': 'Wird pro Layout festgelegt – Bereiche erben immer vom Layout.',
    'design.override.on': 'an',
    'design.override.off': 'aus',
    'design.override.own': 'eigen',
    ...
    'theme.preset.pairDesc':
        'Das Theme folgt dem Browser: hier wählst du je ein Design für Hell und für Dunkel. Der Reiter oben rechts bestimmt, welche der beiden Hälften du gerade bearbeitest — eigene Themes stehen genauso zur Auswahl wie die eingebauten.',
    ...
    'theme.browserSync.title': 'Theme folgt Browser',
    'theme.browserSync.subtitle': 'Wechselt automatisch je nach System-Einstellung (Hell/Dunkel)',
    'theme.browserSync.darkTheme': 'Dunkel-Theme',
    'theme.browserSync.lightTheme': 'Hell-Theme',
    ...
    'theme.user.duplicate': 'Duplizieren',
    'theme.user.delete': 'Löschen',
    'theme.user.confirmDelete': 'Wirklich löschen?',
    ...
    'theme.user.importFailed': 'Die Datei enthält kein Aura-Theme.',
    'theme.user.usedLight': 'Aktiv (hell)',
    'theme.user.usedDark': 'Aktiv (dunkel)',
    'theme.user.usedBoth': 'Aktiv (hell + dunkel)',
    ...
    'editor.tablet.hint':
        'Spalten wie im Tablet-Bereich. Widgets ziehen oder mit den Pfeilen versetzen; ohne Zuordnung abwechselnd in der Mobile-Reihenfolge.',
    'editor.tablet.columns': 'Spalten',
    'editor.tablet.wide': 'Volle Breite',
    'editor.tablet.narrow': 'In eine Spalte',
    'editor.tablet.left': 'Spalte nach links',
    'editor.tablet.right': 'Spalte nach rechts',
    'editor.tablet.up': 'Nach oben',
    'editor.tablet.down': 'Nach unten',
    ...
    'wf.fullscreenOpen': 'Vollbild',
    'wf.fullscreenClose': 'Vollbild beenden (Esc)',
    ...
    'wf.menu.copyStyle': 'Stil kopieren',
    ...
    'wf.menu.discardStyle': 'Kopierten Stil verwerfen',
    ...
    'cond.and': 'UND',
    'cond.or': 'ODER',
    'cond.joinToggle': 'Verknüpfung dieser Zeile umschalten (UND/ODER)',
    'cond.bracketOn': 'Klammer setzen: mit den benachbarten geklammerten Zeilen zusammenfassen',
    'cond.bracketOff': 'Klammer aufheben',
    'cond.bracketSplit': 'Hier eine neue Klammer beginnen',
    'cond.logicPreview': 'Ergibt',
    'cond.logicHint': 'UND bindet stärker als ODER. Für eine andere Reihenfolge die Klammer-Schaltfläche links nutzen.',
    ...
    'badge.countInAggregate': 'In Aggregat-Anzahl zählen',
    'badge.countInAggregateHint': 'Aus: Dieser Marker wird in der Aggregat-Anzahl von Tab und Bereich ignoriert',
    'badge.tabAggregate': 'Aggregat-Anzahl',
    'badge.tabAggregateHint': 'Zeigt eine Zahl über die Marker der Widgets in diesem Tab',
    'badge.sectionAggregate': 'Aggregat-Anzahl',
    'badge.sectionAggregateHint': 'Zeigt eine Zahl über die Marker der Widgets aller Tabs des Bereichs',
    'badge.aggMode': 'Zählt',
    'badge.aggModeWidgets': 'Widgets mit Marker',
    'badge.aggModeWidgetsHint': 'Jedes Widget mit mindestens einem sichtbaren Marker zählt 1',
    'badge.aggModeConditional': 'Nur Marker mit Bedingung',
    'badge.aggModeConditionalHint': 'Dauerhaft sichtbare Marker (z. B. reiner Freitext) werden nicht mitgezählt',
    'badge.aggModeSum': 'Summe der Zahlen',
    'badge.aggModeSumHint': 'Addiert die Werte aller sichtbaren Marker vom Stil „Anzahl (Datenpunkt)“',
    ...
    'rangeChips.title': 'Zeitraum-Auswahl im Frontend',
    'rangeChips.builtIn': 'Standard-Zeiträume',
    'rangeChips.ownList': 'Eigene Liste anlegen',
    'rangeChips.moveLeft': 'Nach vorne',
    'rangeChips.remove': 'Entfernen',
    'rangeChips.value': 'Anzahl',
    'rangeChips.unit': 'Einheit',
    'rangeChips.unit.h': 'Stunden',
    'rangeChips.unit.d': 'Tage',
    'rangeChips.unit.w': 'Wochen',
    'rangeChips.unit.M': 'Monate',
    'rangeChips.unit.y': 'Jahre',
    'rangeChips.add': 'Hinzufügen',
    'rangeChips.total': 'Gesamt',
    'rangeChips.reset': 'Standard',
    'rangeChips.hint':
        'Monate und Jahre zählen nach dem Kalender. Liegt der Standard-Zeitraum nicht in der Liste, startet das Diagramm mit dem ersten Eintrag.',
    ...
    'aircontrol.field.fanSpeedFixed': 'Lüfterstufe (feste Stufe)',
    ...
    'aircontrol.field.humidity': 'Luftfeuchte',
    ...
    'aircontrol.mode.off': 'Aus',
    // Lüfter-Enum (Fallback-Bezeichnungen)
    'aircontrol.fan.auto': 'Auto',
    'aircontrol.fan.quiet': 'Leise',
    'aircontrol.fan.fixed': 'Stufe',
    ...
    // Lamellen-Enum (Rohnamen der Adapter-States)
    'aircontrol.vane.stop': 'Fest',
    'aircontrol.vane.swing': 'Schwenken',
    'aircontrol.vane.windNice': 'Sanft',
    'aircontrol.vane.floorHeating': 'Bodennah',
    ...
    'evcc.sourceLabel': 'Quelle',
    'evcc.sourceManual': 'Manuell – Datenpunkte selbst wählen',
    'evcc.sourceNone': 'Keine Energie-Instanz erkannt – Datenpunkte unten selbst wählen.',
    'evcc.scanning': 'Datenpunkte werden gesucht …',
    'evcc.scanFound': '{n} von {total} Werten zugeordnet – unten prüfen und bei Bedarf ändern.',
    'evcc.scanMissing': 'Nicht gefunden: {slots}.',
    'evcc.scanAgain': 'Erneut suchen',
    'evcc.slot.pv': 'Erzeugung',
    'evcc.slot.home': 'Hausverbrauch',
    'evcc.slot.grid': 'Netz',
    'evcc.slot.batterySoc': 'Batterie-Ladestand',
    'evcc.slot.batteryPower': 'Batterie-Leistung',
    'evcc.sourceSection': 'Datenquelle',
    'evcc.dpSection': 'Datenpunkte',
    'evcc.dpSectionHint':
        'Überschreiben je Wert die Datenquelle. Vollständig gesetzt läuft das Widget ohne evcc – für jede PV-Anlage.',
    'evcc.pvPowerDp': 'Erzeugung (PV)',
    'evcc.homePowerDp': 'Hausverbrauch',
    'evcc.unitWatt': '(W oder kW – wird erkannt)',
    'evcc.batterySocDp': 'Batterie-Ladestand',
    'evcc.batterySocDpHint': '(Prozent oder JSON {soc,power})',
    'evcc.batteryPowerDp': 'Batterie-Leistung',
    'evcc.batteryPowerDpHint': '(negativ = laden)',
    'evcc.loadpointSection': 'Ladepunkte (nur mit evcc)',
    'evcc.loadpointsTotal': 'Ladepunkte (gesamt)',
    'evcc.loadpointsShown': 'Angezeigte Ladepunkte',
    'evcc.prefix': 'evcc-Instanz',
    'evcc.instanceCustom': 'evcc-Präfix von Hand …',
    'evcc.instanceDisabled': '(deaktiviert)',
    'evcc.instanceNone': 'Keine evcc-Instanz gefunden – Präfix von Hand eintragen.',
    'evcc.loadpoints': 'Ladepunkte',
    'evcc.gridPowerDp': 'Netzleistung',
    'evcc.gridPowerDpHint': '(positiv = Bezug, negativ = Einspeisung)',
    ...
    'menu.mode.overview': 'Übersicht',
    'menu.source': 'Quelle',
    'menu.source.layout': 'Aktuelles Layout',
    'menu.source.all': 'Alle Layouts',
    'menu.showSearch': 'Suchfeld anzeigen',
    'menu.searchPlaceholder': 'Tab suchen…',
    'menu.noMatch': 'Keine Treffer',
    'menu.groupTitle': 'Gruppen-Titel',
    'menu.groupTitle.iconName': 'Icon + Name',
    'menu.groupTitle.name': 'Nur Name',
    'menu.groupTitle.none': 'Aus',
    'menu.chipSize': 'Chip-Größe',
    'menu.chipSize.sm': 'Klein',
    'menu.chipSize.md': 'Mittel',
    'menu.chipSize.lg': 'Groß',
    ...
    'countdown.resume': 'Weiter',
    'countdown.stop': 'Stopp',
    'countdown.ended': 'Fertig',
    'countdown.state.idle': 'Bereit',
    'countdown.state.running': 'Läuft',
    'countdown.state.paused': 'Pausiert',
    'countdown.state.ended': 'Abgelaufen',
    'countdown.state.unknown': 'Wartet auf den Adapter',
    'countdown.addTime': '{t} hinzufügen',
    'countdown.removeTime': '{t} abziehen',
    'countdown.setPreset': 'Dauer auf {t} setzen',
    'countdown.setDuration': 'Dauer einstellen',
    'countdown.hours': 'Std',
    'countdown.minutes': 'Min',
    'countdown.seconds': 'Sek',
    'countdown.apply': 'Übernehmen',
    'countdown.cancel': 'Abbruch',
    'countdown.noDatapoint': 'Kein Datenpunkt',
    'countdown.editHint': 'Im Bearbeitungsmodus deaktiviert',
    'countdown.cfg.source': 'Quelle',
    'countdown.cfg.sourceAura': 'Eigener Countdown (läuft im Adapter)',
    'countdown.cfg.sourceDp': 'Fremder Datenpunkt (nur Anzeige)',
    'countdown.cfg.dp': 'Datenpunkt',
    'countdown.cfg.dpKind': 'Inhalt des Datenpunkts',
    'countdown.cfg.dpKind.remainingMs': 'Restzeit in Millisekunden',
    'countdown.cfg.dpKind.remainingS': 'Restzeit in Sekunden',
    'countdown.cfg.dpKind.endTs': 'Endzeitpunkt (Epoch ms oder s, z. B. mytime „end“)',
    'countdown.cfg.duration': 'Dauer',
    'countdown.cfg.durationHint': 'Startwert des Countdowns. ±-Tasten und Vorgaben am Widget ändern ihn zur Laufzeit.',
    'countdown.cfg.step': 'Schritt der ±-Tasten (Sekunden)',
    'countdown.cfg.presets': 'Vorgaben',
    'countdown.cfg.presetsHint': 'Kommagetrennt: 5m, 15m, 1h — oder 90, 1:30, 1:00:00',
    'countdown.cfg.target': 'Ziel-Aktion',
    'countdown.cfg.targetHint':
        'Der Adapter schreibt den Datenpunkt beim Start und am Ende — auch wenn kein Browser offen ist.',
    'countdown.cfg.targetDp': 'Ziel-Datenpunkt',
    'countdown.cfg.valueOnEnd': 'Wert am Ende',
    'countdown.cfg.valueOnStart': 'Wert beim Start (optional)',
    'countdown.cfg.valueHint': 'Wird als Boolean / Zahl / Text geparst. Leer = nichts schreiben.',
    'countdown.cfg.stopWritesEnd': 'Stopp schreibt den Endwert',
    'countdown.cfg.stopWritesEndHint':
        'Ein abgebrochener Countdown schaltet zurück. Ohne Häkchen: Standard an, sobald ein Startwert gesetzt ist.',
    'countdown.cfg.publishRemaining': 'Restzeit sekündlich veröffentlichen',
    'countdown.cfg.publishRemainingHint':
        'Schreibt remainingMs jede Sekunde für Skripte und andere Vis. Erzeugt viele Werte in History-Adaptern.',
    'countdown.cfg.display': 'Anzeige',
    'countdown.cfg.format': 'Format',
    'countdown.cfg.format.auto': 'Automatisch (mm:ss unter einer Stunde)',
    'countdown.cfg.format.hms': 'hh:mm:ss',
    'countdown.cfg.format.ms': 'mm:ss (Minuten gesamt)',
    'countdown.cfg.format.hm': 'hh:mm',
    'countdown.cfg.showDays': 'Tage ab 24 h getrennt zeigen',
    'countdown.cfg.digitSize': 'Ziffern-Größe',
    'countdown.cfg.digitAuto': 'auto',
    'countdown.cfg.showProgress': 'Fortschrittsbalken',
    'countdown.cfg.showControls': 'Start / Pause / Stopp',
    'countdown.cfg.showStep': '±-Tasten',
    'countdown.cfg.showPresets': 'Vorgaben-Chips',
    'countdown.cfg.endedText': 'Text nach Ablauf',
    'countdown.cfg.endedTextHint': 'Leer = 00:00 bleibt stehen.',
    ...
    'hdr.val.actual': 'Ist-Temperatur',
    'hdr.val.target': 'Soll-Temperatur',
    'hdr.val.temperature': 'Temperatur',
    'hdr.val.humidity': 'Luftfeuchte',
    'hdr.val.pressure': 'Luftdruck',
    'hdr.val.metric': 'Zusatzwert:',
    'hdr.val.cell': 'Zelle',
