...
export function CustomJsSection({ contextId, onContextChange }: CustomJsSectionProps) {
    ...
    return (
        ...
        >
            ...
            {contextId &&
                (ls?.customJS !== undefined ||
                    ls?.customJSEnabled !== undefined ||
                    ls?.customJSInEditor !== undefined) && (
            ...
            <label
                className="flex items-center gap-2 cursor-pointer select-none mb-3 text-xs"
                style={{ color: 'var(--text-secondary)' }}
            >
                <button
                    type="button"
            ...
            <div
                ...
                style={{
                    background: 'color-mix(in srgb, var(--accent-red, #ef4444) 8%, transparent)',
