...
export const KEY_DESCRIPTIONS = {
    ...
    showScale:
        ...
        'Sitzt als eigene Zeile unter der Spur (gemessen: +16 px, in aura_measure eingerechnet).',
...
export const WIDGET_OPTION_NOTES = {
    ...
    evcc: {
        ...
        pvPowerDatapoint: { description: 'Datenpunkt der PV-Erzeugung; ueberschreibt die Datenquelle (Watt).' },
        homePowerDatapoint: { description: 'Datenpunkt des Hausverbrauchs; ueberschreibt die Datenquelle (Watt).' },
        gridPowerDatapoint: {
            description: 'Datenpunkt der Netzleistung; ueberschreibt die Datenquelle (Watt, positiv = Bezug).',
        },
...
export const UNIVERSAL_OPTIONS = {
    ...
    collapseInEditor: {
        ts: 'boolean',
        description:
            'Nur zusammen mit defaultCollapsed: auch der Editor zeigt das Widget eingeklappt (Kopfzeile, ' +
            'Klick klappt zum Bearbeiten aus). Ohne diese Option bleibt es im Editor immer ausgeklappt. ' +
            'Die gespeicherte Höhe bleibt in beiden Fällen unangetastet.',
    },
};
