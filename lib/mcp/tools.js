...
const INSTRUCTIONS = [
    ...
    'A folded widget (defaultCollapsed) can show values in its header: options.headerItems, each a',
    'datapoint, a value the widget already has (main value, list sum/count) or a text with bindings, on a',
    'slot beside the title or in a second header row — recipe "eingeklappt-mit-wert".',
