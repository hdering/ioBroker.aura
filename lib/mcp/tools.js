...
const TOOLS = [
    ...
    },
    {
        ...
        description:
            ...
            'than a value row, and a list that mixes them is summed row by row. The answer names the factors ' +
            'that are NOT in the number. With guidelines set it also names the widgets that end outside the ' +
            'target screen.',
        inputSchema: {
            type: 'object',
            properties: {
